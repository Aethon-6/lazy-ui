...
const createCode = () => {
    ...
    // 获取验证码
    codeUrl.value = ""
    loginCodeApi().then((res) => {
        const resData = res.data;

        codeUrl.value = resData.img
        validateCodeKey.value = resData.validateCodeKey
    })
}
            ...
            <div class="content">
                <el-form ref="loginFormRef" :model="loginFormData" :rules="loginFormRules" @keyup.enter="handleLogin">
                    <el-form-item prop="username">
                        <el-input v-model.trim="loginFormData.loginName" placeholder="用户名" type="text" tabindex="1"
                    ...
                    <el-form-item prop="code">
                        <el-input v-model.trim="loginFormData.code" placeholder="验证码" type="text" tabindex="3"
